...
const resources = {
  en: {
    ...
    products: {
      ...
      searchInfo: 'Search for <strong>{{searchTerm}}</strong> in <em>{{category}}</em>',
      allCategories: 'All Categories',
      clearFilters: 'Clear Filters',
      searchFor: 'Searching for: {{term}}',
  ...
  he: {
    ...
    products: {
      ...
      searchInfo: 'חיפוש <strong>{{searchTerm}}</strong> בקטגוריה <em>{{category}}</em>',
      allCategories: 'כל הקטגוריות',
      clearFilters: 'נקה סינון',
      searchFor: 'מחפש: {{term}}',
      inCategory: 'קטגוריה: {{category}}',
      image: 'תמונה',
      title: 'כותרת',
      price: 'מחיר',
      category: 'קטגוריה',
